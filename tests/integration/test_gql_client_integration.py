...
from v8x.schemas import Persona, TokenSet
...
def test_metrics_collection():
    ...
    from v8x.gql_client import QueryMetrics
...
def test_cluster_commands_import():
    ...
    try:
        # Test imports
        from v8x.commands.cluster.delete import delete_cluster
        from v8x.commands.cluster.get import get_cluster
        from v8x.commands.cluster.list import list_clusters
...
def test_error_handling():
    ...
    from v8x.gql_client import AuthenticationError, GraphQLError
