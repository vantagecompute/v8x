...
```text
 ...
 vantage-system
     ...
     $ v8x cluster create mycluster --cloud-account-id 16 --app
 vantage-system --app-config 'jupyterhub_enabled=false'
...
```text
 ...
 Examples:
     v8x cluster preset create cpu-small my-cluster inference-cpu kserve-sklearn
     v8x cluster preset create gpu-vllm my-cluster inference-gpu vllm \\
...
```text
 ...
 Examples:
 v8x cluster preset delete cpu-small my-cluster
 v8x cluster preset delete gpu-vllm my-cluster --force
...
```text
 ...
 Examples:
 v8x cluster preset get cpu-small my-cluster
...
```text
 ...
 Examples:
 v8x cluster preset list my-cluster
...
```text
 ...
 Examples:
 v8x cluster namespace create my-namespace my-cluster
 v8x cluster namespace create my-namespace my-cluster --labels
 '{"env":"dev"}'
...
```text
 ...
 Examples:
 v8x cluster namespace delete my-namespace my-cluster
 v8x cluster namespace delete my-namespace my-cluster --force
...
```text
 ...
 Examples:
 v8x cluster namespace get vantage-kubeflow-james my-cluster
 v8x cluster namespace get vantage-kubeflow-james my-cluster --json
...
```text
 ...
 Examples:
 v8x cluster namespace list my-cluster
 v8x cluster namespace list my-cluster --json
...
```text
 ...
 Examples:
 v8x cluster network delete data-net my-cluster
 v8x cluster network delete data-net my-cluster --force
...
```text
 ...
 Examples:
 v8x cluster network get data-net my-cluster
 v8x cluster network get data-net my-cluster --json
...
```text
 ...
 Examples:
 v8x cluster network list my-cluster
 v8x cluster network list my-cluster --json
...
```text
 ...
 Examples:
 v8x cluster network update data-net my-cluster --mtu 9000
 v8x cluster network update data-net my-cluster --ip-range 10.20.0.0/24
 --gateway 10.20.0.1
 v8x cluster network update vlan10 my-cluster --ip-range 192.168.10.0/24
...
```text
 ...
 Examples:
     v8x cluster kubeflow create my-cluster
     v8x cluster kubeflow create my-cluster --admin-node-group
 kubeflow-admin
...
```text
 ...
 Examples:
 v8x cluster kubeflow get my-cluster
...
```text
 ...
 Examples:
    v8x cluster kubeflow delete my-cluster
    v8x cluster kubeflow delete my-cluster --yes
...
```text
 ...
 Examples:
 v8x cluster secret create hf-token my-cluster --type huggingface --value
 hf_xxxxx
 v8x cluster secret create my-s3 my-cluster --type s3 \\
...
```text
 ...
 Examples:
 v8x cluster secret list my-cluster
 v8x cluster secret list my-cluster --type huggingface
...
```text
 ...
 Examples:
 v8x cluster secret get hf-token my-cluster
...
```text
 ...
 Examples:
 v8x cluster secret delete hf-token my-cluster
 v8x cluster secret delete my-s3 my-cluster --force
...
```text
 ...
 Examples:
 v8x cluster secret test my-s3 my-cluster
...
```text
 ...
 Examples:
    ...
    v8x cluster service enable jupyterhub my-cluster

     # Enable Slurm
    v8x cluster service enable slurm my-cluster

     # Enable MLflow
    v8x cluster service enable mlflow my-cluster
...
```text
 ...
 Examples:
    ...
    v8x cluster service disable jupyterhub my-cluster

     # Disable Slurm
    v8x cluster service disable slurm my-cluster

     # Disable MLflow
    v8x cluster service disable mlflow my-cluster

     # Force delete SLURM when it's broken
    v8x cluster service disable slurm my-cluster --force
...
```text
 ...
 Examples:
    ...
    v8x cluster service update jupyterhub my-cluster

     # Reconcile Slurm
    v8x cluster service update slurm my-cluster

     # Re-sync MLflow
    v8x cluster service update mlflow my-cluster
...
```text
 ...
 Examples:
     # Create a PVC viewer
     v8x cluster service create pvc-viewer my-cluster

     # Create a cloud shell
     v8x cluster service create cloud-shell my-cluster

     # Create a remote desktop with specific resolution
     v8x cluster service create remote-desktop my-cluster -r 2560x1440

     # Create a remote desktop on a GPU node
     v8x cluster service create remote-desktop my-cluster -i gpu

     # Create a remote desktop with a specific image version
     v8x cluster service create remote-desktop my-cluster --image-version
 1.2.3

     # Create a cloud shell with a specific image version
     v8x cluster service create cloud-shell my-cluster --image-version 0.9.0
...
```text
 ...
 Examples:
     # Delete a PVC viewer
    v8x cluster service delete pvc-viewer abc12345-... my-cluster

     # Delete a cloud shell without confirmation
    v8x cluster service delete cloud-shell def67890-... my-cluster --force
...
```text
 ...
 v8x cluster service get pvc-viewer abc12345-... my-cluster

 # Get details of a cloud shell
 v8x cluster service get cloud-shell def67890-... my-cluster
...
```text
 ...
 Examples:
     # List your services
    v8x cluster service list my-cluster

     # List only your cloud shells
    v8x cluster service list my-cluster --service-type cloud-shell

     # List services for a specific user (admin)
    v8x cluster service list my-cluster --username alice

     # List all users' services (admin)
    v8x cluster service list my-cluster --all-users
...
```text
 ...
 Examples:
     v8x cluster slurm create hpc-prod my-cluster slurm-admin cpu:slurm-compute:default \\
         --exposed --profiling \\
...
```text
 ...
 Examples:
    v8x cluster slurm delete hpc-prod my-cluster
    v8x cluster slurm delete ml-dev my-cluster --yes
...
```text
 ...
 Examples:
 v8x cluster slurm get hpc-prod my-cluster
 v8x cluster slurm get ml-dev my-cluster
...
```text
 ...
 Examples:
 v8x cluster slurm list my-cluster
...
```text
 ...
 Examples:
    v8x cluster slurm update hpc-prod my-cluster --profiling
    v8x cluster slurm update ml-dev my-cluster --no-bridge
    v8x cluster slurm update research my-cluster --exposed --no-tls
