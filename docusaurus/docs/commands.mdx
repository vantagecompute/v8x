...
│                     Vantage cluster.                                         │
│ service-preset      Manage unified service presets (inference, trainjob,     │
...
```text
 ...
 Examples:
     ...
     v8x cluster service create remote-desktop -c my-cluster -p desktop-md -r
 2560x1440
...
│    --name                TEXT  Optional custom service name (auto-generated  │
│                                when omitted).                                │
│    --preset      -p      TEXT  UserServicePreset name supplying sizing, node │
│                                group, Slurm attachment, and extra labels     │
│                                (see 'GET                                     │
│                                /vdeployer/service-presets/user-service').    │
│    --image               TEXT  Image override: a bare tag replaces the       │
│                                version on the workload's default registry    │
│                                image; a value containing '/' or ':' is used  │
│                                as a full reference.                          │
│    --resolution  -r      TEXT  Desktop resolution for remote-desktop (e.g.,  │
│                                1920x1080).                                   │
│    --json        -j            Output in JSON format                         │
│    --verbose     -v            Enable verbose terminal output                │
│    --profile     -p      TEXT  Profile name to use                           │
