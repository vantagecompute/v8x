...
│ nemo                  Browse the in-cluster NeMo microservices catalogs      │
...
<TabItem value="cluster-blueprint" label="blueprint">

<Tabs>
<TabItem value="cluster-blueprint-main" label="🔹 blueprint">
...
<TabItem value="cluster-blueprint-list" label="list">
...
<TabItem value="cluster-blueprint-get" label="get">
...
<TabItem value="cluster-nemo" label="nemo">

```text

 Usage: v8x cluster nemo [OPTIONS] COMMAND [ARGS]...

 Browse the in-cluster NeMo microservices catalogs (Customizer / Evaluator).
...
<TabItem value="cluster-ray" label="ray">

<Tabs>
<TabItem value="cluster-ray-main" label="🔹 ray">
...
<TabItem value="cluster-ray-create" label="create">
...
<TabItem value="cluster-ray-list" label="list">
...
<TabItem value="cluster-ray-get" label="get">
...
<TabItem value="cluster-ray-delete" label="delete">
...
<TabItem value="cluster-ray-clusters" label="clusters">
