...
"""Profile CRUD SDK for managing v8x profiles."""
...
from v8x.cache import clear_token_cache
...
from v8x.profiles.schema import Profile, load_profiles
...
class ProfileSDK:
    ...
    This SDK provides operations for managing v8x profiles,
    which contain settings for connecting to Vantage API instances.
    Profiles are persisted to ~/.v8x/profiles.json.
    """
    ...
    def delete(self, profile_name: str, force: bool = False) -> bool:
        ...
        try:
            ...
            # Remove from file
            from v8x.profiles.schema import load_profiles, save_profiles
