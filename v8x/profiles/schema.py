...
from v8x.constants import USER_CONFIG_FILE

logger = logging.getLogger(__name__)


def load_profiles() -> Dict[str, Any]:
    """Load profiles data from ~/.v8x/profiles.json.
...
def save_profiles(profiles_data: Dict[str, Any]) -> None:
    """Save profiles data to ~/.v8x/profiles.json.
...
class Profile(BaseModel):
    ...
    def write(self) -> None:
        ...
        This method saves the profile settings to ~/.v8x/profiles.json.
        """
        from v8x.config import dump_settings
