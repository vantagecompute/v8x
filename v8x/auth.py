...
"""Authentication and authorization functionality for the v8x."""
...
from v8x.cache import load_tokens_from_cache, save_tokens_to_cache
from v8x.client import make_oauth_request
from v8x.config import Settings
from v8x.constants import (
    OIDC_DEVICE_PATH,
    OIDC_SCOPES,
    OIDC_TOKEN_PATH,
...
def refresh_access_token_standalone(token_set: TokenSet, settings: "Settings") -> bool:
    ...
    try:
        with httpx.Client() as client:
            ...
            token_set.id_token = token_data.get("id_token")
...
async def refresh_access_token(ctx: CliContext, token_set: TokenSet):
    ...
    token_set.id_token = refreshed_token_set.id_token
