...
"""Deployment schemas for the v8x."""
...
from v8x.constants import V8X_DEPLOYMENTS_YAML_PATH as DEPLOYMENTS_YAML


def load_deployments() -> Dict[str, Any]:
    """Load deployment tracking data from ~/.v8x/deployments.yaml.
...
def save_deployments(deployments_data: Dict[str, Any]) -> None:
    """Save deployment tracking data to ~/.v8x/deployments.yaml.
...
class Deployment(BaseModel):
    ...
    cloud: Cloud
    cloud_account_id: Optional[int] = None  # ID of the cloud account used for this deployment
    substrate: str
    status: str
    ...
    def write(self) -> None:
        ...
        and saves it back to ~/.v8x/deployments.yaml.
