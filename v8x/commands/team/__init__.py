...
from .add_resource import add_team_resource
...
from .set_roles import set_team_roles
...
team_app.command("add-resource", help="Add a resource (cluster) to a team")(add_team_resource)
...
team_app.command("set-roles", help="Set team-level roles (kubeflow-admin, etc.)")(set_team_roles)
